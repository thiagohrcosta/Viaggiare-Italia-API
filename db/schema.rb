...
ActiveRecord::Schema.define(version: 2022_06_25_173326) do

  # These are extensions that must be enabled in order to support this database
  enable_extension "plpgsql"

  create_table "banner_places", force: :cascade do |t|
    t.string "photo_url"
  ...
  create_table "product_complements", force: :cascade do |t|
    t.string "name"
    t.decimal "price"
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
